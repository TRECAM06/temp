...
dataset = 'training_data3/training_data3.csv'
model_save_path = 'keypoint_classifier.hdf5'
#tflite_save_path = 'NeuralTraining/keypoint_classifier.tflite'

NUM_CLASSES = 9

X_dataset = np.loadtxt(dataset, delimiter=',', dtype='float32', usecols=list(range(1, 11)))
print(X_dataset[0:1])
...
print(X_test[0])
predict_result = model.predict(X_dataset[1:2])
